...
public class ShortMessage extends MidiMessage {
     ...
     * @throws Exception if {@code status} does not specify
     ...
     * @since 1.7
     */
    public ShortMessage(int status) throws Exception {
        super(null);
        setMessage(status); // can throw Exception
    }
     ...
     * @throws Exception if the status byte or all data bytes
    ...
    public ShortMessage(int status, int data1, int data2)
            throws Exception {
        super(null);
        setMessage(status, data1, data2); // can throw Exception
    }
     ...
     * @param data1    the first data byte
     * @param data2    the second data byte
     * @throws Exception if the command value, channel value
     ...
     * @param status    the MIDI status byte
     * @throws  Exception if <code>status</code> does not
